...
###取得原始碼並存檔
html = requests.get(url + '//czbooks.net/n/u2695', headers = request_headers)
#print (html.text)
...
###取章節內容源碼
for i in date[shi::2]:#5614=2802章 5616=2803章
    #print(i)
    ...
    title = tag_h1.text.replace('《全職法師》','')#拿來當檔名
    print('正在下載：'+ title)
    content1 = content.find('div',class_="content")#class是Python的保留字，所以Beautiful Soup改以class_
    #print(content1.text)
    #存入內容    
    f = open('C:/Users/jimmy2799/Desktop/全職法師/{}.txt'.format(title), mode ='w', encoding ='utf-8')
    f.write(title+'\n'*2)
